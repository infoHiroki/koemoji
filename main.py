...
class KoemojiApp:
    ...
    def build_ui(self):
        ...
        # リストボックスとスクロールバー
        self.file_listbox = tk.Listbox(file_list_frame_inner, height=6, selectmode=tk.EXTENDED)
        ...
        # ステータステキスト
        self.status_text = tk.Text(status_frame, height=12, width=80, wrap=tk.WORD, state=tk.DISABLED)
